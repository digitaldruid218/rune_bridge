...
<!--          <div style="display: flex; justify-content: space-between; width: 100%;">-->
<!--            <label for="tick2">Collateral Token:</label>-->
<!--            <input type="text" id="tick2" v-model="loanData.tick2" style="text-align: right;">-->
<!--          </div>-->

          <div style="display: flex; justify-content: space-between; width: 100%;">
            <label for="inscription">Collateral Inscription(receive):</label>
            <input type="text" id="inscription" v-model="loanData.inscription" style="text-align: right;">
          </div>

          <div style="display: flex; justify-content: space-between; width: 100%;">
            <label for="amount2">Collateral Inscription Amount(receive):</label>
            <div style="display: flex;">
...
const values = ref({ debtAmt: '', colAmt: '', repayAmt: '' }); // 입력된 값들을 저장하는 객체
const formattedValues = ref({ debtAmt: '', colAmt: '', repayAmt: '' }); // 포맷팅된 값들을 저장하는 객체
...
onMounted(() => {
  ...
  console.log(BTCBalance.value, tokenBalances['btc'])
...
const clickSubmit = async () =>{
  ...
  // console.log(typeof(loanData.value['offExpiryTime']))
  // console.log(currentTime, loanData.value['offExpiryTime'], currentTime >= loanData.value['offExpiryTime'])
  if(loanData.value['lenderAddr'] === '' || loanData.value['lenderAddr'] === undefined){
    ...
    alert("Error, Please enter \"Collateral Inscription Amount\"");
    ...
    await signMessageAndEnqueueTransaction(
        {
          ...
          "inscription": loanData.value['inscription'],
          "amount2": loanData.value['amount2'],
